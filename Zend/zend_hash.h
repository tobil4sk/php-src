...
static zend_always_inline zend_hash_key_type zend_hash_get_current_key(const HashTable *ht, zend_string **str_index, HT_KEY_TYPE *num_index) {
...
static zend_always_inline zval *zend_hash_index_find_deref(const HashTable *ht, HT_KEY_TYPE h)
{
