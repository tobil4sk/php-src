...
./configure --with-iconv=/usr/local --with-external-pcre
# options used for pure-cap benchmark CHERI:
CC="cc -mabi=purecap-benchmark" PKG_CONFIG_LIBDIR=/usr/local64cb/libdata/pkgconfig:/usr/lib64cb/pkgconfig ../configure --with-iconv=/usr/local64cb --with-external-pcre --prefix=/usr/local64cb
# options used for hybrid CHERI:
CC="cc -mabi=aapcs" PKG_CONFIG_LIBDIR=/usr/local64/libdata/pkgconfig:/usr/lib64/pkgconfig ../configure --with-iconv=/usr/local64 --with-external-pcre --prefix=/usr/local64
```
